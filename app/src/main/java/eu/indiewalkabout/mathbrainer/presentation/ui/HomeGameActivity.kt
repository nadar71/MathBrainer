...
class HomeGameActivity : AppCompatActivity() {
        ...
        if (checkConsentActive) {
            ...
            consentSDK.checkConsent(object : ConsentSDK.ConsentCallback() {
                override fun onResult(isRequestLocationInEeaOrUnknown: Boolean) {
                    ...
                    mAdView.loadAd(ConsentSDK.getAdRequest(this@HomeGameActivity))
                }
            })
    ...
    private fun setBtnPressedListener() {
        ...
        doublingBtn.setOnClickListener {
            val intent = Intent(this@HomeGameActivity, eu.indiewalkabout.mathbrainer.presentation.games.arithmetic.DoubleNumberActivity::class.java)
    ...
    companion object {
        ...
        private val TAG = HomeGameActivity::class.java.simpleName
