...
/**
 * -------------------------------------------------------------------------------------------------
 * Same game as MixedOp_Write_Result_Activity, apart that is only about differences
 * Changed only the symbols array to have only : "-"
 * -------------------------------------------------------------------------------------------------
 */
public class Diff_Write_Result_Activity extends AppCompatActivity implements IGameFunctions {

    // admob banner ref
    private AdView mAdView;

    // tag for log
    private final static String TAG = Diff_Write_Result_Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diff_write_result);

        mAdView = findViewById(R.id.adView);

        // You have to pass the AdRequest from ConsentSDK.getAdRequest(this) because it handle the right way to load the ad
        mAdView.loadAd(ConsentSDK.getAdRequest(Diff_Write_Result_Activity.this));
        ...
        countDownIndicator = new CountDownIndicator(Diff_Write_Result_Activity.this, (ProgressBar) countdownBar, Diff_Write_Result_Activity.this);
    ...
    private void endGame() {
        ...
        Toast.makeText(Diff_Write_Result_Activity.this, "Congrats! Your score is : " + score + " on " + numChallengeEachLevel, Toast.LENGTH_LONG).show();
