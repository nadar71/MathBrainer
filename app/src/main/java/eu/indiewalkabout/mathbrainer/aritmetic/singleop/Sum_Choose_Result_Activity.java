...
/**
 * -------------------------------------------------------------------------------------------------
 * Same game as MixedOp_Choose_Result_Activity, apart that is only about summs
...
public class Sum_Choose_Result_Activity extends AppCompatActivity implements IGameFunctions {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countDownIndicator = new CountDownIndicator(Sum_Choose_Result_Activity.this, (ProgressBar) countdownBar, Sum_Choose_Result_Activity.this);
    ...
    private void checkPlayerInput() {
        ...
        if (pressedBtnValue != 0  && pressedBtnValue == answerOK) {
            Toast.makeText(Sum_Choose_Result_Activity.this, "OK!", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(Sum_Choose_Result_Activity.this, "WRONG...", Toast.LENGTH_SHORT).show();
    ...
    private void endGame() {
        ...
        Toast.makeText(Sum_Choose_Result_Activity.this, "Congrats! Your score is : " + score + " on " + numChallengeEachLevel, Toast.LENGTH_LONG).show();
