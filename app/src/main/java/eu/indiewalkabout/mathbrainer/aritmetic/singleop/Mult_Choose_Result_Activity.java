...
/**
 * -------------------------------------------------------------------------------------------------
 * Same game as MixedOp_Choose_Result_Activity, apart that is only about multiplications
 * Changed only the symbols array to have only : "*"
 * -------------------------------------------------------------------------------------------------
 */
public class Mult_Choose_Result_Activity extends AppCompatActivity implements IGameFunctions {

    // admob banner ref
    private AdView mAdView;

    // tag for log
    private final static String TAG = Mult_Choose_Result_Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mult_choose_result);

        mAdView = findViewById(R.id.adView);

        // You have to pass the AdRequest from ConsentSDK.getAdRequest(this) because it handle the right way to load the ad
        mAdView.loadAd(ConsentSDK.getAdRequest(Mult_Choose_Result_Activity.this));
        ...
        countDownIndicator = new CountDownIndicator(Mult_Choose_Result_Activity.this, (ProgressBar) countdownBar, Mult_Choose_Result_Activity.this);
    ...
    private void checkPlayerInput() {
        ...
        if (pressedBtnValue != 0  && pressedBtnValue == answerOK) {
            Toast.makeText(Mult_Choose_Result_Activity.this, "OK!", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(Mult_Choose_Result_Activity.this, "WRONG...", Toast.LENGTH_SHORT).show();
    ...
    private void endGame() {
        ...
        Toast.makeText(Mult_Choose_Result_Activity.this, "Congrats! Your score is : " + score + " on " + numChallengeEachLevel, Toast.LENGTH_LONG).show();
