...
public class Sum_Write_Result_Activity extends AppCompatActivity implements IGameFunctions {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdView.loadAd(ConsentSDK.getAdRequest(Sum_Write_Result_Activity.this));
    ...
    private void setupCustomKeyboard() {
        ...
        keyboard.setInputConnection(ic, Sum_Write_Result_Activity.this);
    }
    ...
    public void checkPlayerInput() {
        ...
        if (inputNum != 0  && inputNum == answerOK) {
            ...
            endSessiondialog = new EndGameSessionDialog(this,
                    Sum_Write_Result_Activity.this,
