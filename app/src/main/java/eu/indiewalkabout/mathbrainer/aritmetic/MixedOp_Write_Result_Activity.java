...
public class MixedOp_Write_Result_Activity extends AppCompatActivity implements IGameFunctions {

    // admob banner ref
    private AdView mAdView;

    // tag for log
    private final static String TAG = MixedOp_Write_Result_Activity.class.getSimpleName();
    ...
    private void endGame() {
        ...
        Toast.makeText(MixedOp_Write_Result_Activity.this, "Congrats! Your score is : " + score + " on " + numChallengeEachLevel, Toast.LENGTH_LONG).show();
