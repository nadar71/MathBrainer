...
class DoubleNumberActivity : AppCompatActivity(), IGameFunctions {
    ...
    private lateinit var livesValueIv: java.util.ArrayList<ImageView>
    ...
    private var timerLength = CountDownIndicator.Companion.DEFAULT_MILLISINFUTURE
    private val timerCountDownInterval = CountDownIndicator.Companion.DEFAULT_COUNTDOWNINTERVAL
