...
import kotlinx.android.synthetic.main.activity_choose_game_new.*
...
class ChooseGameActivity : AppCompatActivity() {
    ...
    private fun setBtnPressedListener() {
        ...
        highscore_img.setOnClickListener {
    ...
    companion object {
        ...
        private val TAG = ChooseGameActivity::class.java.simpleName
